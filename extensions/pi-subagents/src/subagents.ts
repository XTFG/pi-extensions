...
export default function (pi: ExtensionAPI) {
	pi.registerTool<typeof SubagentParams, SubagentDetails>({
		...
		promptGuidelines: [
			...
			"When subagent_spawn is available, use that detached tool only for independent sidecar work, then immediately perform meaningful non-overlapping work; completion is delivered automatically, so do not poll or wait unless blocked.",
